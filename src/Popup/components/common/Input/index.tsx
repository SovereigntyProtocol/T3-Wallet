...
type InputProps = OutlinedInputProps & {
  helperText?: string;
  setIsPasswordShown?: React.Dispatch<React.SetStateAction<string>>;
};

export default function Input({ type, setIsPasswordShown, helperText, multiline, ...remainder }: InputProps) {
            ...
            <InputAdornment position="end">
              <IconButton
                onClick={() => {
                  ...
                  if (setIsPasswordShown) setIsPasswordShown((prev) => (prev === 'password' ? 'text' : 'password'));
                }}
                edge="end"
              >
